...
def int_check(question):
    while True:
        ...
        try:
            ...
            # checks that the umber is more / equal to 13
            if response < 13:
                print(error)
            else:
                return response
...
while user_score < target_score and comp_score < target_score:
    ...
    while computer_points <= 13 and user_points <= 13:
        ...
        # If user has 13 points, we can assume hey don't want to roll again!
        if user_points == 13:
            user_pass = "yes"
        ...
        if roll_again == "yes":
            ...
            if user_points > 13:
                ...
                # resets user points to zero so that when we update their
                ...
                print(f"You rolled a {user_move} and now have a total of {user_points}.")
        ...
        print()
        # Tell user if they are winning, losing or if
    ...
    # currently does ot include double points
    elif user_points > computer_points:
    ...
    print()
    print(f"🎲🎲🎲 User: {user_points} points | Computer: {comp_score} points 🎲🎲🎲")
    print()
